...
for k in range(n_iterations):
    ...
    for i in range(N):
        ...
        # comm.Allreduce(MPI.IN_PLACE, coarse_guess, op=MPI.SUM)
...
#     print("Average time for all processes - CN: ", avg_time)
#
#     with open("run_times_default.txt", "a") as myfile:
#         myfile.write(str(avg_time))

# speed_up = 1 / ((1 + n_iterations / size) * (avg_time / (avg_time + 0.5)) + (n_iterations / size))
# print(speed_up)